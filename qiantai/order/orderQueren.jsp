  ...
  <head>
    ...
    <script language="javascript">
	        ...
	        function dd()
	        {
	            ...
	            if(odderFukuangfangshi=="支付宝")
	            {
	                 document.getElementById("qukanma").style.display="block";
	            }
	        }
	        ...
	        function pay()
	        {
	        	var strUrl = "<%=path %>/img/1521265155519.jpg";
	        	var ret = window.open(strUrl,"","dialogWidth:300px; dialogHeight:500px; dialogLeft: status:no; directories:yes;scrollbars:yes;Resizable=no;");
		                        ...
		                        <table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
					              ...
					              <tr align='center' bgcolor="#FFFFFF" height="22">
					                  ...
					                  <td width="80%" align="left">
		   		                          ...
		   		                          <input type="button" onclick="pay()" id="qukanma" style="display: none" value="查看二维码"/>
		                              </td>
					              </tr>
		        				</table>
		        				<table>
